...
画面の左側で、**イベント** を確認します。 以前に作成したイベントがそのリストに表示されます。 選択して、ジャーニーキャンバスにドラッグ&amp;ドロップします。 ジャーニーは次のようになります。 「**保存**」をクリックします。
...
温度コンテキストごとに、顧客にテキストメッセージを送信しようとします。 この演習では、携帯電話番号ではなく、実際のメッセージをSlackチャネルに送信します。
...
温度コンテキストごとに、顧客にメッセージを送信しようとします。 この演習では、携帯電話番号ではなく、実際のメッセージをSlackチャネルに送信します。
