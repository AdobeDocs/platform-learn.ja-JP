---
title: Customer Journey Analytics- Analysis Workspaceでのデータの準備
description: Customer Journey Analytics- Analysis Workspaceでのデータの準備
kt: 5342
...
# 11.4 Analysis Workspaceでのデータの準備
...
## 11.4.1 CJA でのAnalysis Workspace UI
...
## 11.4.3 計算Dimension:フィルター（セグメント化）と日付範囲
...
次のステップ： [11.5Customer Journey Analyticsを使用したビジュアライゼーション](./ex5.md)
