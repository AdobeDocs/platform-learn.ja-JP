...
## CJA用 1.5.2.1Claude.ai でカスタムアプリを作成する
...
次の手順：[MCP サーバーを使用したAdobe Analyticsと Claude.ai](./ex3.md){target="_blank"}
