---
title: 新しいアセットの作成、レビューおよび承認
description: 新しいアセットの作成、レビューおよび承認
role: Developer
level: Beginner
jira: KT-5342
doc-type: Tutorial
...
プロジェクトマネージャーは、その画像の現在のバージョンを確認して、何が起こっているのか、これが積極的に取り組んでいるのかを知ることができるようになりました。 **Frame.io で開く** をクリックします。

![WF](./images/wffio15.png)

新しいウィンドウが開き、アセットが Frame.io に表示されます。
