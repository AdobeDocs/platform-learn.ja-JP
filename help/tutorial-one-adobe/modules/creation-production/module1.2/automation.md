...
[1.2.2 コネクタを使用した自動化 &#x200B;](./ex2.md){target="_blank"}

この演習では、引き続きジャーニーの調整を行って、画像作成プロセスを自動化します。

[1.2.3 Frame.io とWorkfront Fusion](./ex3.md){target="_blank"}

この演習では、Frame.io をWorkfront Fusion シナリオに接続します。

Workfront Fusion とAEM Assetsの [1.2.4 Frame.io](./ex4.md){target="_blank"}
