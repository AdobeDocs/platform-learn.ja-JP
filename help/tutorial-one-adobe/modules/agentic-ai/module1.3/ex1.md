...
## 1.3.2 全体的な購入トレンドから始めて、コンテキストを固定し、ファイバーにズームインする
...
## 1.3.5 関連する履歴プロモのシードオーディエンスを確認する
...
## 1.3.6 フォールアウト分析によるジャーニーのパフォーマンスの検証
...
## 1.3.7 高い使用率に合わせて既存のオーディエンスを検索する
...
## 1.3.8 オーディエンスがすでに使用されているかどうかを判断する
...
## 1.3.9 Fibre Max Launch の新しいジャーニーの作成
