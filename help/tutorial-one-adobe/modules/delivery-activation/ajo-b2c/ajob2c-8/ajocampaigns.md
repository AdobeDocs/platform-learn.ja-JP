...
# 3.8 Adobe Journey Optimizer：調整されたキャンペーン
...
- Adobe Journey Optimizerでリレーショナルスキーマのを設定する方法を説明します
- Adobe Journey Optimizerでデータを取り込む方法を説明します
- Adobe Journey Optimizerでオーケストレートキャンペーンを設定および使用する方法について説明します。

## 前提条件

- Adobe Journey Optimizerで調整されたキャンペーンへのアクセス
