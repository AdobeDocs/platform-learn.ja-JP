...
## 1.3.1.4 サンプルデータの取り込み

これで、データベースへのサンプルデータの読み込みを開始できます。

「**+作成」をクリックし** 「**SQL ワークシート**」を選択します。
...
この画像が表示されます。 クリックして **ドロップダウン** リストを開き、「**すべて実行**」を選択してすべてのクエリを実行します。

![FAC](./images/dataload3.png)

これには数分かかり、その後、これが表示されます。
