...
![データ取り込み](./images/sdkpm2.png)

次に、**本文** に移動します。 プレースホルダー **{{body}}** を選択します。

![データ取り込み](./images/sdkpm3.png)
...
![データ取り込み](./images/sdkpm11.png)

上記のコードを貼り付けた後、フィールド **destinationDelivery を手動で更新する必要があります。 destinationServerId**。この例で **成した、前の手順で作成した宛先サーバーテンプレートの** instanceId`52482c90-8a1e-42fc-b729-7f0252e5cebd` に設定する必要があります。 次に、「**送信** をクリックします。

![データ取り込み](./images/sdkpm10.png)

この応答が表示されます。

![データ取り込み](./images/sdkpm12.png)
