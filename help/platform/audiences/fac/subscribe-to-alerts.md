---
title: Federated Audience Composition アラートの購読
description: Federated Audience Composition アラートを購読して、実行の成功と失敗の両方に関するアプリ内通知またはメール通知を受け取る方法を説明します。 これを有効にするには、Experience Platform製品の通知設定で環境設定を行います。
...
# Federated Audience Composition アラートの購読
