...
セグメント化やパーソナライゼーションで使用するために、リアルタイム顧客プロファイルに追加される顧客傾向スコアと顧客離れスコアを構築する方法を説明します。
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="introduction-to-customer-ai.md" target="_blank" rel="referrer" title="顧客AIの概要">顧客AIの概要</a>
                    </p>
                    <p class="is-size-6">マーケターがCustomer AIを使用して顧客予測を生成する方法の概要。</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Business Value of Customer AI">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="business-value-of-customer-ai.md" target="_blank" rel="referrer" title="Customer AIのビジネス価値">Customer AI のビジネス価値</a>
                    </p>
                    <p class="is-size-6">このビデオでは、Customer AIが、AI ベースの傾向で顧客プロファイルを強化し、顧客セグメンテーションとターゲティングの取り組みを強化する方法を示します。</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Introduction to Attribution AI">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="introduction-to-attribution-ai.md" target="_blank" rel="referrer" title="アトリビューション AIの概要"> アトリビューション AIの概要</a>
                    </p>
                    <p class="is-size-6">マーケターとアナリストがAttribution AIを使用して、マーケティングチャネルとキャンペーンのインパクトを把握する方法の概要。</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Business Value of Attribution AI">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="business-value-of-attribution-ai.md" target="_blank" rel="referrer" title="アトリビューション AIのビジネス価値">Attribution AI のビジネス価値</a>
                    </p>
                    <p class="is-size-6">この動画では、マーケターがアトリビューション AIを利用して、カスタマージャーニーの各段階における個々の顧客とのやり取りの影響を把握することで、マーケティング費用と広告費用を測定し、最適化する方法を紹介します。</p>
                </div>
