...
Adobe Experience Platform を使用すると、クエリサービスを標準機能として JupyterLab に統合することにより、Data Science Workspace で構造化照会言語（SQL）を使用できます。このチュートリアルでは、データの調査、変換、分析をおこなう一般的な使用例をいくつか示します。 詳しくは、 [Data Science Workspace ドキュメントのクエリサービス](https://experienceleague.adobe.com/docs/experience-platform/data-science-workspace/jupyterlab/query-service.html).
