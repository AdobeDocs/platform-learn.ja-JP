---
title: Adobe Experience Platform Agent Orchestrator インターフェイスの使用
description: コンテキストプロンプト、動的オブジェクト、Adobe Experience Platform Agent Orchestratorを使用した複数の特殊なエージェントなどを通じてExperience Cloud ソリューションを操作する方法について説明します。
