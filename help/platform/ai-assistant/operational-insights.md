---
title: AI アシスタントで運用インサイトを取得
description: AI アシスタントを使用して、Adobe Experience Platformのオーディエンス、データセット、スキーマ、宛先、ジャーニーなどのビジネスオブジェクトに関する運用インサイトを明らかにする方法を説明します
