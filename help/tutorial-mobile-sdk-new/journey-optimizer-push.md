...
>[!TIP]
>
>アプリを既に [Journey Optimizerのアプリ内メッセージ](journey-optimizer-inapp.md) チュートリアルでは、この節をスキップできます。
...
これで、プッシュ通知を送信するジャーニーの構築を開始し、Journey Optimizerからプッシュ通知を処理するアプリを処理するすべてのツールが揃いました。 例えば、アプリにログインする際にユーザーを受け入れるような場合です。
