...
1. **[!UICONTROL path equals]** で、`/` `OR` `/index.html` 設定します。 Luma デモ Web サイトの場合、ルールがホームページにのみトリガーされるようにします
...
1. [Luma デモ web サイト &#x200B;](https://luma.enablementadobe.com){target="_blank"} に移動します
...
上記で、[Luma ホームページ &#x200B;](https://luma.enablementadobe.com) のデータストリーム上書きを設定しました。  この設定を検証するには
...
[Livingston All-Purpose Tight 製品ページ &#x200B;](https://luma.enablementadobe.com/product.html?id=LLMP09) などの製品ページに移動します。  コンテンツページビューが Analytics によってキャプチャされていることを検証します。
...
1. [Marco Lightweight Active Hoodie](https://luma.enablementadobe.com/product.html?id=LLMH13) をカートに追加します。
1. [&#x200B; 買い物かごページ &#x200B;](https://luma.enablementadobe.com/cart.html) に移動し、次のEdge Trace を確認します
