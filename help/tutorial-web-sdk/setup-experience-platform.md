...
タグプロパティにマッピングされた [Luma デモサイト &#x200B;](https://luma.enablementadobe.com) でトラフィックを生成すると、Experience Platformのデータセットにデータが入力されます。
...
1. [Luma デモサイト &#x200B;](https://luma.enablementadobe.com) を開き、[!UICONTROL Experience Platform Debugger] 拡張機能アイコンを選択します
