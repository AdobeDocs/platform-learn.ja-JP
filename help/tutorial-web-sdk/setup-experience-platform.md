...
1. **[!UICONTROL Edgeのセグメント化]** を有効にします。

1. 「**[!UICONTROL 保存]**」を選択します。

   ![&#x200B; データストリーム設定 &#x200B;](assets/experience-platform-datastream-config.png)

タグプロパティにマッピングされた [Luma デモサイト &#x200B;](https://newluma.enablementadobe.com) でトラフィックを生成すると、Experience Platformのデータセットにデータが入力されます。
...
1. [Luma デモサイト &#x200B;](https://newluma.enablementadobe.com) を開き、[!UICONTROL Experience Platform Debugger] 拡張機能アイコンを選択します
...
1. 各 ID のすべての **[!UICONTROL 顧客プロファイル]** を表示するには、メインウィンドウで **[!UICONTROL プロファイル ID]** を選択します。
   ...
   ここでは、`lumaCRMId` など、`ECID` にリンクされているすべての ID が表示されます。
