...
* **Journey Optimizer** の場合：
   * オプションの **Web キャンペーン** レッスンでは、**[!UICONTROL キャンペーンを管理]**、**[!UICONTROL キャンペーンを公開]** および **[!UICONTROL キャンペーンレポートを表示]** するための権限項目が必要です。
  <!--
...
[![Luma web サイト &#x200B;](assets/old-overview-luma.png)](https://newluma.enablementadobe.com){target="blank"}
