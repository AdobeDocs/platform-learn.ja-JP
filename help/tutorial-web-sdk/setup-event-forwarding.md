...
1. [Luma デモ web サイト &#x200B;](validate-with-debugger.md#use-the-experience-platform-debugger-to-map-to-your-tag-property) で [&#x200B; タグライブラリの切り替え &#x200B;](https://luma.enablementadobe.com/category-men.html) 手順に従って、データストリームのイベント転送プロパティのマッピング先の Web SDK タグプロパティに移動します。
