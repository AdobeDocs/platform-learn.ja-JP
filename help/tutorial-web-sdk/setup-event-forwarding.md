...
1. [Luma デモサイト &#x200B;](validate-with-debugger.md#use-the-experience-platform-debugger-to-map-to-your-tag-property) で、データストリームのイベント転送プロパティのマッピング先の Web SDK タグプロパティに [&#x200B; タグライブラリの切り替え &#x200B;](https://newluma.enablementadobe.com/category-men.html) の手順に従います。
