...
3. Luma デモ web サイトでタグライブラリを読み込みます
...
Luma デモ Web サイトに移動して検証し、Cookie を拒否し、オプトアウト後に web SDK リクエストが実行されないことを確認します。
...
1. Experience Platform Web SDK拡張機能の **[!UICONTROL 同意]** セクションで、デフォルトの同意を、必要に応じて **[!UICONTROL アウト]** または **[!UICONTROL 保留中]** に設定します。
...
>[!TIP]
>
> このレッスンを完了したら、3 つの新しいルールを無効にすることをお勧めします。
