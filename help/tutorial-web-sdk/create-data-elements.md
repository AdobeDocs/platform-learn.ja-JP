...
[Luma デモサイト &#x200B;](https://newluma.enablementadobe.com) で、コンテンツ、コマース、ID データのタグでデータ要素を作成する方法を説明します。 次に、XDM スキーマのフィールドにAdobe Experience Platform Web SDK拡張機能の変数データ要素タイプを入力します。
...
>[!IMPORTANT]
>
>このレッスンのデータは、Luma サイトの `[!UICONTROL adobeDataLayer]` データレイヤーから得られます。 データレイヤーを表示するには、開発者コンソールを開き、`[!UICONTROL adobeDataLayer]` と入力して、使用可能な完全なデータレイヤーを表示します。![adobeDataLayer データレイヤー &#x200B;](assets/data-element-data-layer-new.png)
...
XDM オブジェクトを作成する前に、[Luma デモサイト &#x200B;](https://newluma.enablementadobe.com){target="_blank"} データレイヤーに次のデータ要素のセットを作成します。
...
* 次のカスタムコードを使用して **`Ecommerce Checkout Products`** きます。
