...
1. [Luma ホームページ ](https://luma.enablementadobe.com) （タグプロパティにマッピング）と **Adobe Experience Platform Debugger** を開き、ページを更新します。
...
1. [Luma デモ web サイトのホームページ ](https://luma.enablementadobe.com) を開き、タグプロパティにマッピングして、新しく作成したセグメントに適合するようにします。
