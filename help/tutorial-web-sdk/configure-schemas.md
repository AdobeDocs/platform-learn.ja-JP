...
>[!NOTE]
>
> デモ目的で、このレッスンの演習では、顧客が閲覧したコンテンツと購入した製品を [Luma デモ Web サイト &#x200B;](https://luma.enablementadobe.com) でキャプチャするサンプルスキーマを作成します。 このスキーマ例を作成する手順に従って、スキーマエディターの機能を学び、後で独自のビジネス用のスキーマを作成する準備を整えます。
...
この演習では、[Luma デモ web サイト &#x200B;](https://luma.enablementadobe.com){target="_blank"} で web イベントデータを取得するための推奨ベースラインフィールドグループを使用して、XDM スキーマを作成します。
